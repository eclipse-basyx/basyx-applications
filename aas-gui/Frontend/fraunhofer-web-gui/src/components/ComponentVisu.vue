<template>
    <v-container fluid class="ma-0 pa-0">
        <v-card v-show="!minimized" tile elevation="0" :height="isMobile ? '' : 'calc(100vh - 112px)'" color="card" class="visCard">
            <v-card-title class="header">
                <div v-if="!isMobile">Visualization</div>
                <v-spacer v-if="!isMobile"></v-spacer>
                <v-checkbox v-if="SelectedProperty && SelectedProperty != {} && SelectedProperty != null && SelectedProperty.modelType.name === 'Property' && !cleared" hide-details label="Führungskomponente" @change="switchVisu" style="margin-top: -2px" :value="isStateMachine"></v-checkbox>
            </v-card-title>
            <v-divider></v-divider>
            <v-card-text style="overflow-y: auto;" :style="{height: isMobile ? '' : 'calc(100vh - 176px)' }" v-show="SelectedProperty && SelectedProperty != {} && SelectedProperty != null && !cleared">
                <!-- svg graphic state machine -->
                <svg v-show="SelectedProperty && SelectedProperty.modelType.name === 'Property' && isStateMachine" id="PackML" viewBox="0 0 1856 1012">
                    ...
                    <g id="Clearing_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M920.68,905h8.39v2.57h-11.6V889.11h3.21Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M942.34,899.35h-7.59V905h8.87v2.57H931.54V889.11h12v2.59h-8.78v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M956.58,903.29h-7.16l-1.49,4.31h-3.34l7-18.49h2.88l7,18.49H958.1Zm-6.25-2.59h5.35L953,893Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M983.16,907.6H980V889.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1001.77,907.6h-3.21l-8.24-13.12V907.6H987.1V889.11h3.22l8.26,13.17V889.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Unsuspending_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M478.4,589.11v12.36a6,6,0,0,1-1.88,4.66,8.29,8.29,0,0,1-10.07,0,6.05,6.05,0,0,1-1.86-4.71V589.11h3.2v12.37a3.92,3.92,0,0,0,.94,2.83,3.66,3.66,0,0,0,2.76,1c2.48,0,3.71-1.31,3.71-3.91V589.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M496.49,607.6h-3.21L485,594.48V607.6h-3.21V589.11H485l8.27,13.17V589.11h3.18Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M529.5,589.11v12.36a6,6,0,0,1-1.89,4.66,7.13,7.13,0,0,1-5,1.72,7.23,7.23,0,0,1-5-1.69,6.05,6.05,0,0,1-1.86-4.71V589.11h3.2v12.37a3.92,3.92,0,0,0,.94,2.83,3.64,3.64,0,0,0,2.76,1c2.47,0,3.71-1.31,3.71-3.91V589.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M576,599.35h-7.59V605h8.87v2.57H565.24V589.11h12v2.59h-8.78v5.11H576Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M594.6,607.6h-3.21l-8.24-13.12V607.6h-3.21V589.11h3.21l8.26,13.17V589.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M618.77,607.6h-3.2V589.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M637.38,607.6h-3.21l-8.24-13.12V607.6h-3.21V589.11h3.21l8.27,13.17V589.11h3.18Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Idle_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M138.72,347.6h-3.2V329.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M162.87,345h8.39v2.57h-11.6V329.11h3.21Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M184.53,339.35h-7.59V345h8.87v2.57H173.72V329.11h12v2.59h-8.78v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                        </g>
                    </g>
                    <g id="Unholding_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M502.21,69.11V81.47a6,6,0,0,1-1.88,4.66,8.29,8.29,0,0,1-10.07,0,6.05,6.05,0,0,1-1.86-4.71V69.11h3.2V81.48a3.92,3.92,0,0,0,.94,2.83,3.66,3.66,0,0,0,2.76,1c2.48,0,3.71-1.31,3.71-3.91V69.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M520.3,87.6h-3.21l-8.24-13.12V87.6h-3.21V69.11h3.21l8.27,13.17V69.11h3.18Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M538.77,87.6h-3.2V79.4h-8.26v8.2H524.1V69.11h3.21v7.7h8.26v-7.7h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M563.73,85h8.39V87.6h-11.6V69.11h3.21Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M595,87.6h-3.2V69.11H595Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M613.57,87.6h-3.21l-8.24-13.12V87.6h-3.21V69.11h3.21l8.27,13.17V69.11h3.18Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Held_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M944.44,87.6h-3.2V79.4H933v8.2h-3.21V69.11H933v7.7h8.26v-7.7h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M959,79.35h-7.59V85h8.87V87.6H948.24V69.11h12V71.7h-8.78v5.11H959Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M966.15,85h8.39V87.6h-11.6V69.11h3.21Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Holding_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M1321.07,87.6h-3.2V79.4h-8.26v8.2h-3.22V69.11h3.22v7.7h8.26v-7.7h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1346,85h8.39V87.6h-11.6V69.11H1346Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1377.26,87.6h-3.2V69.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1395.87,87.6h-3.21l-8.24-13.12V87.6h-3.21V69.11h3.21l8.26,13.17V69.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Starting_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M529.87,331.7H524.1v15.9h-3.18V331.7H515.2v-2.59h14.67Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M541.12,343.29H534l-1.5,4.31h-3.34l7-18.49H539l7,18.49h-3.35Zm-6.26-2.59h5.35L537.54,333Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M577,331.7h-5.77v15.9h-3.18V331.7h-5.72v-2.59H577Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/><path d="M582.83,347.6h-3.2V329.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M601.44,347.6h-3.21L590,334.48V347.6h-3.21V329.11H590l8.27,13.17V329.11h3.18Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Execute_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M917.55,339.35H910V345h8.88v2.57H906.75V329.11h12v2.59H910v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M927.81,335.79l3.89-6.68h3.7l-5.58,9.17,5.71,9.32h-3.75l-4-6.78-4,6.78h-3.73l5.73-9.32-5.6-9.17h3.71Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M948.71,339.35h-7.59V345H950v2.57H937.9V329.11h12v2.59h-8.78v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M983.1,329.11v12.36a6,6,0,0,1-1.89,4.66,7.13,7.13,0,0,1-5,1.72,7.23,7.23,0,0,1-5-1.69,6.05,6.05,0,0,1-1.86-4.71V329.11h3.2v12.37a3.92,3.92,0,0,0,.94,2.83,3.64,3.64,0,0,0,2.76,1c2.47,0,3.71-1.31,3.71-3.91V329.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M999.88,331.7h-5.76v15.9h-3.19V331.7h-5.71v-2.59h14.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1013.11,339.35h-7.59V345h8.87v2.57h-12.08V329.11h12v2.59h-8.78v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                        </g>
                    </g>
                    <g id="Completing_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M1319.67,329.11l5.33,14.17,5.32-14.17h4.15V347.6h-3.2v-6.1l.32-8.15-5.46,14.25h-2.3l-5.45-14.23.32,8.13v6.1h-3.2V329.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1358.1,345h8.39v2.57h-11.61V329.11h3.22Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1379.75,339.35h-7.59V345H1381v2.57H1369V329.11h12v2.59h-8.79v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1397.26,331.7h-5.76v15.9h-3.19V331.7h-5.71v-2.59h14.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1403.08,347.6h-3.2V329.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1421.69,347.6h-3.22l-8.23-13.12V347.6H1407V329.11h3.22l8.26,13.17V329.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Complete_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M1734.06,329.11l5.34,14.17,5.31-14.17h4.16V347.6h-3.2v-6.1l.31-8.15-5.45,14.25h-2.3l-5.45-14.23.32,8.13v6.1h-3.2V329.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1772.49,345h8.39v2.57h-11.6V329.11h3.21Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1794.15,339.35h-7.59V345h8.87v2.57h-12.08V329.11h12v2.59h-8.78v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1811.66,331.7h-5.77v15.9h-3.18V331.7H1797v-2.59h14.67Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1824.89,339.35h-7.6V345h8.88v2.57h-12.09V329.11h12v2.59h-8.79v5.11h7.6Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                        </g>
                    </g>
                    <g id="Resetting_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M120.49,599.35H112.9V605h8.87v2.57H109.69V589.11h12v2.59H112.9v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M150.88,599.35h-7.59V605h8.88v2.57H140.08V589.11h12v2.59h-8.79v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M168.39,591.7h-5.76v15.9h-3.19V591.7h-5.71v-2.59h14.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M184.38,591.7h-5.77v15.9h-3.19V591.7h-5.71v-2.59h14.67Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M190.19,607.6H187V589.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M208.8,607.6h-3.21l-8.24-13.12V607.6h-3.21V589.11h3.21l8.26,13.17V589.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Suspended_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M917.7,589.11v12.36a6,6,0,0,1-1.89,4.66,7.13,7.13,0,0,1-5,1.72,7.23,7.23,0,0,1-5-1.69,6.05,6.05,0,0,1-1.86-4.71V589.11h3.2v12.37a3.92,3.92,0,0,0,.94,2.83,3.64,3.64,0,0,0,2.76,1c2.47,0,3.71-1.31,3.71-3.91V589.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M964.24,599.35h-7.59V605h8.87v2.57H953.44V589.11h12v2.59h-8.78v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M982.8,607.6h-3.21l-8.24-13.12V607.6h-3.21V589.11h3.21l8.26,13.17V589.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M986.6,607.6V589.11h5.46a8.51,8.51,0,0,1,4.34,1.1,7.37,7.37,0,0,1,2.94,3.09,9.78,9.78,0,0,1,1,4.6v.93a9.89,9.89,0,0,1-1,4.62,7.38,7.38,0,0,1-3,3.07,8.94,8.94,0,0,1-4.43,1.08Zm3.21-15.9V605h2.09a4.8,4.8,0,0,0,3.88-1.58,6.89,6.89,0,0,0,1.38-4.54v-1a7.08,7.08,0,0,0-1.31-4.6,4.63,4.63,0,0,0-3.79-1.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1014.39,599.35h-7.6V605h8.88v2.57h-12.09V589.11h12v2.59h-8.79v5.11h7.6Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Suspending_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M1311.8,589.11v12.36a6,6,0,0,1-1.89,4.66,8.27,8.27,0,0,1-10.06,0,6.06,6.06,0,0,1-1.87-4.71V589.11h3.2v12.37a4,4,0,0,0,.94,2.83,3.68,3.68,0,0,0,2.77,1c2.47,0,3.71-1.31,3.71-3.91V589.11Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1358.34,599.35h-7.59V605h8.87v2.57h-12.09V589.11h12v2.59h-8.78v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1376.9,607.6h-3.21l-8.24-13.12V607.6h-3.22V589.11h3.22l8.26,13.17V589.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1401.07,607.6h-3.2V589.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1419.68,607.6h-3.21l-8.24-13.12V607.6H1405V589.11h3.21l8.26,13.17V589.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Stopping_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M528,891.7h-5.77v15.9h-3.18V891.7h-5.72v-2.59H528Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M584.67,907.6h-3.2V889.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M603.28,907.6h-3.21l-8.24-13.12V907.6h-3.21V889.11h3.21l8.27,13.17V889.11h3.18Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Stopped_Group">
                        ...
                        <g style="isolation:isolate">
                            ...
                            <path d="M133.93,891.7h-5.76v15.9H125V891.7h-5.71v-2.59h14.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M198,899.35H190.4V905h8.87v2.57H187.19V889.11h12v2.59H190.4v5.11H198Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Aborted_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M1314.87,903.29h-7.16l-1.5,4.31h-3.34l7-18.49h2.89l7,18.49h-3.35Zm-6.26-2.59H1314l-2.68-7.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1385.12,891.7h-5.76v15.9h-3.19V891.7h-5.71v-2.59h14.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1398.35,899.35h-7.59V905h8.87v2.57h-12.08V889.11h12v2.59h-8.79v5.11h7.59Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="Aborting_Group">
                        ...
                        <g style="isolation:isolate">
                            <path d="M1709,903.29h-7.16l-1.49,4.31H1697l7-18.49h2.88l7,18.49h-3.35Zm-6.25-2.59h5.35l-2.68-7.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            ...
                            <path d="M1779.22,891.7h-5.76v15.9h-3.19V891.7h-5.71v-2.59h14.66Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1785,907.6h-3.2V889.11h3.2Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                            <path d="M1803.65,907.6h-3.21l-8.24-13.12V907.6H1789V889.11h3.22l8.26,13.17V889.11h3.19Z" transform="translate(-31.5 -10.5)" :style="{fill: $vuetify.theme.dark ? '#272727' : '#ffffff'}"/>
                    ...
                    <g id="held-unholding">
                        <line x1="634.5" y1="69.5" x2="822.72" y2="69.5"/><line x1="648.85" y1="69.5" x2="822.72" y2="69.5" style="fill:none;stroke:#000;stroke-miterlimit:10"/>
                ...
                <v-img v-show="!isStateMachine" src="@/assets/industry-4-point-0.svg"></v-img>
            </v-card-text>
        </v-card>
        <!-- minimized window -->
        <v-card v-show="minimized" tile elevation="0" height="calc(100vh - 114px)" color="card" class="visCard2">
            ...
            <v-card-text style="overflow-y: auto; height: calc(100vh - 176px)">
                <div class="title" style="transform: rotate(-90deg); transform-origin: top left; white-space: nowrap; margin-top: 118px; margin-left: -2px">Visualization</div>
            </v-card-text>
        </v-card>
    </v-container>
</template>
...
export default {
    ...
    data() {
        return {
            isStateMachine: false, // is the selected prop a "Führungskomponente"
            minimized: false,
            observer: null,
            observerMinimized: null,
            oldWidth: document.getElementsByClassName('visCard')[0] ? document.getElementsByClassName('visCard')[0].offsetWidth : 0,
            cleared: false,
        }
    },
    ...
    watch: {
        RealtimeProperty: {
            deep: true,
            handler() {
                this.setSVG(); // initialize list
            }
        },
        SelectedProperty: {
            deep: true,
            handler() {
                this.initializeVisuData(); // initialize list
                this.cleared = false;
            }
        },
        registryServer() {
    ...
    mounted() {
        let card = document.getElementsByClassName('visCard')[0];
        this.observer = new ResizeObserver(this.checkWidth).observe(card);
        let cardMinimized = document.getElementsByClassName('visCard2')[0];
        this.observerMinimized = new ResizeObserver(this.checkWidth).observe(cardMinimized);
        if(document.getElementsByClassName('visCard')[0].offsetWidth < 360) {
    ...
    computed: {
        ...
        RealtimeProperty() {
            return this.$store.getters.getRealtimeProp;
        },
        states() {
            return [
                {
    ...
    methods: {
        // initialize visu with data from selected property
        initializeVisuData() {
            // console.log('initializeList', this.SelectedProperty);
            this.isStateMachine = false; // reset checkbox state
        },
        // switch between PackML Statemachine Visu and Placeholder
        switchVisu(e) {
            // console.log('switchVisu', e);
            this.isStateMachine = e;
            if(e) {
                this.setSVG(); // initialize visu on checkbox activation
            }
        },
        // method to set the visual state of the PackML SVG
        setSVG() {
            // console.log('setSVG', this.states);
            if(this.isStateMachine) {
                let states = this.states;
                // console.log('states', states, this.RealtimeProperty);
                states.forEach(state => {
                    if(this.RealtimeProperty.value && state.text === this.makeUniform(this.RealtimeProperty.value)) {
                        // console.log('found')
                        // console.log(state.path.style)
                        state.path.style.strokeWidth      = "4";
                        // state.path.style.strokeDasharray  = "10 4";
                        state.path.style.stroke           = this.$vuetify.theme.dark ? "#ff0000" : "#ff0000";
                        state.path.style.fill    = "rgb(0,0,0);";
                        // state.path.style.length       = 2;
                    } else {
                        // console.log('not found')
                        if(state.path != undefined) {
                            // console.log(state.path.style)
                            state.path.style.strokeWidth      = "";
                            // state.path.style.strokeDasharray  = "";
                            state.path.style.stroke           = "";
                            state.path.style.fill    = "";
                            // state.path.style.length       = 1;
                        }
                    }
                });
            }
        },
        // uniform state string
        makeUniform(state) {
        ...
        checkWidth() {
            let width = 0; 
            if(this.minimized) {
                width = document.getElementsByClassName('visCard2')[0].offsetWidth;
            } else {
                width = document.getElementsByClassName('visCard')[0].offsetWidth;
            }
            // console.log(this.oldWidth,width);
            if(this.oldWidth >= 360 && width < 360 && this.oldWidth != 0) {
                // console.log('minimized');
                this.minimize('byDrag');
            } else if(this.oldWidth <= 361 && width > 361 && this.oldWidth != 0) {
                this.minimize('byDrag');
            }
            this.oldWidth = width;
        },
