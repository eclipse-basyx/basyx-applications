<template>
    <v-container fluid class="pa-0">
        <v-card color="elevatedCard" class="mt-4">
            <v-list v-if="submodelElementListObject.value.length > 0" nav class="bg-elevatedCard">
                <div v-for="(SubmodelElement, i) in submodelElementListObject.value" :key="i">
                    ...
                    <v-divider v-if="i < submodelElementListObject.value.length - 1" class="mt-2 mb-1"></v-divider>
                </div>
            </v-list>
