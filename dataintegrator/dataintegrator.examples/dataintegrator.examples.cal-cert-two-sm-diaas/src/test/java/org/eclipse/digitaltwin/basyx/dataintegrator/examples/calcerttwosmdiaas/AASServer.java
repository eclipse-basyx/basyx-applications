package org.eclipse.digitaltwin.basyx.dataintegrator.examples.calcerttwosmdiaas;
...
public class AASServer {
	...
	private void configureAAS() {
		...
		aasServerConfig.setAASSourceAsList("src/test/resources/aasx/Cal_Cert_Two_SMs_Config.aasx");
