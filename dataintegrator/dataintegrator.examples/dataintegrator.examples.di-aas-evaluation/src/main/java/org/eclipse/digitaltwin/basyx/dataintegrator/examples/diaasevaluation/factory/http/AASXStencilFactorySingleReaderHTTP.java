...
public class AASXStencilFactorySingleReaderHTTP {
	...
	public AASXStencilFactorySingleReaderHTTP(int level) {
		this.level = level;
	}
	...
	private Submodel createSubmodel() {
		...
		SubmodelElementCollection prevSMC = createSMC("location", 0);
		
		SubmodelElementCollection smcAddress = createSMC("addresses", 0);
...
//		}
		...
		Property address = new Property("address", "");

		smcAddress.addSubmodelElement(address);
		
		prevSMC.addSubmodelElement(smcAddress);
