...
class DiAASEvaluationTest2 {
	...
	public static void init() throws IOException, TransformerException, ParserConfigurationException {
		AASXConfigFactoryMultiReaders aasxConfigFactory = new AASXConfigFactoryMultiReaders(new AASXStencilFactoryMultiReader(STENCIL_LEVEL));
