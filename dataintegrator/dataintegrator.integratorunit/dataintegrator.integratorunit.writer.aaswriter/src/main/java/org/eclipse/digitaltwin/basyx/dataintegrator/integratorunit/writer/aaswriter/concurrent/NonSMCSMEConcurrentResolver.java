...
import org.eclipse.digitaltwin.basyx.dataintegrator.integratorunit.writer.aaswriter.factory.NonSMCConfigMapFactory;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class NonSMCSMEConcurrentResolver {
	
	private static Logger logger = LoggerFactory.getLogger(NonSMCSMEConcurrentResolver.class);
	...
	private static Map<String, SubmodelElement> performTask(Map<String, ISubmodelElement> mapPart, AasEnv aasEnv) {
		...
		return NonSMCConfigMapFactory.create(mapPart, aasEnv);
    }
