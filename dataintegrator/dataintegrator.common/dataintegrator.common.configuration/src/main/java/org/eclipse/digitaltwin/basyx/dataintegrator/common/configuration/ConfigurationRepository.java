package org.eclipse.digitaltwin.basyx.dataintegrator.common.configuration;
...
public class ConfigurationRepository {
	...
	private static Logger logger = LoggerFactory.getLogger(ConfigurationRepository.class);
