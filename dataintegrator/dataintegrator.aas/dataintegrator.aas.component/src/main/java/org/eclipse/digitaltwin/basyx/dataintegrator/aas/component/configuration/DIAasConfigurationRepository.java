...
@Component
public class DIAasConfigurationRepository implements ConfigurationRepository {
	
	private static Logger logger = LoggerFactory.getLogger(DIAasConfigurationRepository.class);
